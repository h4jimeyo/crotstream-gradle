...
import com.crottv.crotstream.gradle.entities.PluginManifest
import com.crottv.crotstream.gradle.makeManifest
...
const val TASK_GROUP = "crotstream"
    ...
    project.afterEvaluate {
        val make = project.tasks.register("make", Zip::class.java) {
            ...
            it.doLast { task ->
                ...
                task.logger.lifecycle("Made Crotstream package at ${task.outputs.files.singleFile}")
            }
        }
